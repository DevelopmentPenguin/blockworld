package com.intermaticcore.blockworld.core;

import com.intermaticcore.blockworld.character.Zombie;
import com.intermaticcore.blockworld.level.*;
import com.intermaticcore.blockworld.level.tile.Tile;
...
public class Blockworld implements Runnable {
    ...
    public void run() {
        try {
            ...
            JOptionPane.showMessageDialog(null, e, "Failed to start Blockworld", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
        }
    ...
    public static void main(String[] args) {
        new Thread(new Blockworld()).start();
    }
}
